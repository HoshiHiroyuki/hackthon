/* checksum : e8dde9a9da6788afec8cc8361bd0555f */
@cds.external : true
...
entity ZAPI_PURCHASEORDER_PROCESS_SRV.A_PurchaseOrder {
  ...
  to_PurchaseOrderItem : Association to many ZAPI_PURCHASEORDER_PROCESS_SRV.A_PurchaseOrderItem on to_PurchaseOrderItem.PurchaseOrder = PurchaseOrder;
  @cds.ambiguous : 'missing on condition?'
  to_PurchaseOrderNote : Association to many ZAPI_PURCHASEORDER_PROCESS_SRV.A_PurchaseOrderNote on to_PurchaseOrderNote.PurchaseOrder = PurchaseOrder;
};
...
entity ZAPI_PURCHASEORDER_PROCESS_SRV.A_PurchaseOrderItem {
  ...
  @cds.ambiguous : 'missing on condition?'
  to_AccountAssignment : Association to many ZAPI_PURCHASEORDER_PROCESS_SRV.A_PurOrdAccountAssignment on to_AccountAssignment.PurchaseOrderItem = PurchaseOrderItem and to_AccountAssignment.PurchaseOrder = PurchaseOrder;
  @cds.ambiguous : 'missing on condition?'
  to_PurchaseOrder : Association to ZAPI_PURCHASEORDER_PROCESS_SRV.A_PurchaseOrder {  };
  @cds.ambiguous : 'missing on condition?'
  to_PurchaseOrderItemNote : Association to many ZAPI_PURCHASEORDER_PROCESS_SRV.A_PurchaseOrderItemNote on to_PurchaseOrderItemNote.PurchaseOrderItem = PurchaseOrderItem and to_PurchaseOrderItemNote.PurchaseOrder = PurchaseOrder;
  @cds.ambiguous : 'missing on condition?'
  to_PurchaseOrderPricingElement : Association to many ZAPI_PURCHASEORDER_PROCESS_SRV.A_PurOrdPricingElement on to_PurchaseOrderPricingElement.PurchaseOrderItem = PurchaseOrderItem and to_PurchaseOrderPricingElement.PurchaseOrder = PurchaseOrder;
  @cds.ambiguous : 'missing on condition?'
  to_ScheduleLine : Association to many ZAPI_PURCHASEORDER_PROCESS_SRV.A_PurchaseOrderScheduleLine on to_ScheduleLine.PurchasingDocumentItem = PurchaseOrderItem and to_ScheduleLine.PurchasingDocument = PurchaseOrder;
};
...
entity ZAPI_PURCHASEORDER_PROCESS_SRV.A_PurchaseOrderScheduleLine {
  ...
  @cds.ambiguous : 'missing on condition?'
  to_SubcontractingComponent : Association to many ZAPI_PURCHASEORDER_PROCESS_SRV.A_POSubcontractingComponent on to_SubcontractingComponent.ScheduleLine = ScheduleLine and to_SubcontractingComponent.PurchaseOrderItem = PurchasingDocumentItem and to_SubcontractingComponent.PurchaseOrder = PurchasingDocument;
};
